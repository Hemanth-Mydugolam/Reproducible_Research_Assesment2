...
dsetzip <- "StormData.csv.bz2"
dsetrds <- "StormData.RDS"
...
```{r}
plot1=ggplot(data=fatalities[1:10,], aes(x=EVTYPE, y=FATALITIES)) + 
...
plot2=ggplot(data=injuries[1:10,], aes(x=EVTYPE, y=INJURIES)) + 
...
```{r}
plot3=ggplot(data=property[1:10,], aes(x=EVTYPE, y=propertyDamage)) + 
...
plot4=ggplot(data=crop[1:10,], aes(x=EVTYPE, y=cropDamage)) + 
